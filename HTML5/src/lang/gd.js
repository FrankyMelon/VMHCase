videojs.addLanguage('gd', {
  ...
  "LIVE": "BEÒ",
  "Seek to live, currently behind live": "A&rsquo; sireadh sruth beò &rsquo;s air dheireadh",
  "Seek to live, currently playing live": "A&rsquo; sireadh sruth beò &rsquo;s ‘ga chluich",
  ...
  "You aborted the media playback": "Sguir thu de chluich a&rsquo; mheadhain",
  ...
  "The media could not be loaded, either because the server or network failed or because the format is not supported.": "Cha b&rsquo; urrainn dhuinn am meadhan a luchdadh – dh&rsquo;fhaoidte gun do dh&rsquo;fhàillig leis an fhrithealaiche no an lìonra no nach cuir sinn taic ris an fhòrmat.",
  "The media playback was aborted due to a corruption problem or because the media used features your browser did not support.": "Sguir sinn de chluich a&rsquo; mheadhain – dh&rsquo;fhaoidte gu bheil e coirbte no gu bheil gleus aig a&rsquo; mheadhan nach cuir am brabhsair taic ris.",
  "No compatible source was found for this media.": "Cha ceach tùs co-chòrdail a lorg airson a&rsquo; mheadhain seo.",
  "The media is encrypted and we do not have the keys to decrypt it.": "Tha am meadhan crioptaichte &rsquo;s chan eil iuchair dì-chrioptachaidh againn dha.",
  ...
  "This modal can be closed by pressing the Escape key or activating the close button.": "&rsquo;S urrainn dhut seo a dhùnadh leis an iuchair Escape no leis a&rsquo; phutan dùnaidh.",
  ...
  "Font Size": "Meud a&rsquo; chrutha-chlò",
  ...
  "Uniform": "Cunbhalach",
  "Dropshadow": "Sgàil",
  "Font Family": "Teaghlach a&rsquo; chrutha-chlò",
  ...
  "Beginning of dialog window. Escape will cancel and close the window.": "Toiseach uinneag còmhraidh. Sguiridh Escape dheth &rsquo;s dùinidh e an uinneag",
  "End of dialog window.": "Deireadh uinneag còmhraidh.",
  "{1} is loading.": "Tha {1} &rsquo;ga luchdadh."
});